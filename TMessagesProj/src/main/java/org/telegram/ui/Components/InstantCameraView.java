...
import org.telegram.messengerz.camera.CameraController;
import org.telegram.messengerz.camera.CameraInfo;
import org.telegram.messengerz.camera.CameraSession;
import org.telegram.messengerz.camera.Size;
...
public class InstantCameraView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void startAnimation(boolean open) {
        ...
        animatorSet.playTogether(
                ...
                ObjectAnimator.ofFloat(switchCameraButton, "alpha", open ? 1.0f : 0.0f),
                ObjectAnimator.ofFloat(muteImageView, "alpha", 0.0f),
                ObjectAnimator.ofInt(paint, "alpha", open ? 255 : 0),
            ...
            switch (what) {
                ...
                case DO_SETSESSION_MESSAGE: {
                    ...
                    if (currentSession == newSession) {
                        rotationAngle = currentSession.getWorldAngle();
                        android.opengl.Matrix.setIdentityM(mMVPMatrix, 0);
                        if (rotationAngle != 0) {
